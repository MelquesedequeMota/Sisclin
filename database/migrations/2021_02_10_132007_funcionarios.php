...
class Funcionarios extends Migration
{
    ...
    public function up()
    {
        Schema::create('funcionarios', function (Blueprint $table) {
            ...
            $table->string('func_rg')->unique()->nullable();
            $table->string('func_estadocivil');
            $table->string('func_cep')->nullable();
            $table->string('func_logradouro')->nullable();
            $table->string('func_num')->nullable();
            $table->string('func_complemento')->nullable();
            $table->string('func_bairro')->nullable();
            $table->string('func_cidade')->nullable();
