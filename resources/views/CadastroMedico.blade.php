...
<body>
        ...
        <div class='input' id='maximoatendimento'>Quantidade máxima de atendimentos:<input type='number' class='valores' name='maximoatendimento' value ='1' min='1' max='100' value='1'>
        <div class='input' id='maximoretorno'>Quantidade máxima de retornos:<input type='number' class='valores' name='maximoretorno' value ='1' min='1' max='100' value='1'>
...
<script>
    ...
    for(var o = 0; o<dias.length; o++){
        ...
        if(o > 6){
            document.getElementById(dias[o]).value = '00:00:00';
        }else{
            document.getElementById(dias[o]).value = '00:00:00';
        }
